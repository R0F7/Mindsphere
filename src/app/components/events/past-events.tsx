  ...
  return (
    <section className="pb-[100px] px-[5%] bg-[var(--white)]" id="past">
      <div className="max-w-[1100px] mx-auto">
        ...
        {/* --- HEADER --- */}
        <div className="mb-[32px] pt-[60px] border-t border-[var(--border)]" data-aos="fade-up">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[20px]">
          {PAST_EVENTS.map((event, i) => (
            <div
              key={event.id}
              className="group bg-[var(--off-white)] border border-[var(--border)] rounded-[var(--radius-lg)] overflow-hidden cursor-pointer transition-all duration-300 hover:-translate-y-[5px] hover:shadow-[var(--shadow-md)]"
              data-aos="fade-up"
            ...
            >
              ...
              <div className="p-[16px]">
                ...
                <div className="text-[0.78rem] font-medium text-[var(--text)] inline-flex items-center gap-[5px] transition-[gap] duration-200 group-hover:gap-[8px]">
                  View Recap <span className="text-[1.1rem] leading-none">›</span>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="text-center pt-[48px]" data-aos="fade-up">
          <button className="inline-flex items-center gap-[10px] px-[32px] py-[13px] border border-[var(--strong)] rounded-full font-sans text-[0.88rem] font-normal text-[var(--t2)] bg-[var(--white)] transition-all duration-250 cursor-pointer shadow-[var(--shadow-sm)] hover:bg-[var(--navy)] hover:text-white hover:border-[var(--navy)] hover:shadow-[var(--shadow-md)] group/btn">
            <svg 
