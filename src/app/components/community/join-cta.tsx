    ...
    <section className="relative overflow-hidden bg-navy dark:bg-soft py-25 px-[5%]">
      ...
      <div className="max-w-175 mx-auto text-center relative z-10">
        ...
        <blockquote
          ...
          data-aos-delay="80"
        >
          Someone out there feels exactly like you do right now. You just
        ...
        <div data-aos="fade-up" data-aos-delay="240">
          <PrimaryButton href="/platforms" className="px-9 bg-white text-navy dark:bg-accent dark:text-white"> Join the Community →</PrimaryButton>
        </div>
      </div>
    </section>
  );
