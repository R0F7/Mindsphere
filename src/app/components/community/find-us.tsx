        ...
        <div className="container w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="absolute top-5 right-5 bg-navy text-white text-[0.7rem] font-medium px-3 py-1.5 rounded-(--rf) flex items-center gap-1.25">
                <span className="w-1.25 h-1.25 w-[5px] h-[5px] rounded-full bg-[#4ADE80] shrink-0" />
                Join Discord
              </div>
