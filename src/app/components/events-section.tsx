      ...
      <div className="mx-auto container w-full">
        <div className="text-center mb-12" data-aos="fade-up">
          ...
          <h2 className="font-fraunces text-3xl md:text-4xl font-normal text-primary">
            Events &{" "}
            <em className="italic font-light text-accent">Gatherings</em>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-6 w-full">
          ...
          <div
            className="group bg-white border border-border rounded-xl overflow-hidden flex flex-col transition-shadow duration-300 hover:shadow-md w-full"
            data-aos="fade-right"
          >
            ...
            <div className="p-7 flex-1 flex flex-col">
              ...
              <p className="text-[0.875rem] text-secondary leading-relaxed font-light mb-6 pb-5 border-b border-border flex-1">
                Our flagship annual event bringing together teens, counselors,
                and mental health advocates for a full day of connection,
                workshops, and honest conversations about what it means to be a
                teenager today.
              </p>
