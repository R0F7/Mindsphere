...
export default function HelplineSection() {
  const HELPLINES: Helpline[] = [
    {
      ...
      desc: "Text-based crisis support available 24/7. Connect with a trained crisis counselor by sending a text message. Free, confidential, available any time.",
      avail: "24/7",
      avClass: "av24",
    ...
    {
      name: "Teen Line",
      desc: "A peer support helpline staffed by specially trained teenagers for teenagers. Talk to someone who truly understands — because they've been there.",
      avail: "6PM–10PM daily",
      avClass: "avday",
    ...
    {
      name: "Samaritans",
      desc: "Confidential emotional support for anyone struggling to cope. Available any time by phone or email. No judgment — just a calm voice ready to listen.",
      avail: "24/7",
      avClass: "av24",
      phone: "116 123",
      chat: false,
    ...
    {
      name: "iCall",
      desc: "Psychosocial helpline offering counselling and mental health support to individuals experiencing emotional distress, anxiety, depression, and other challenges.",
      avail: "Mon–Sat 8AM–10PM",
      avClass: "avday",
      phone: "+91 9152987821",
      chat: true,
    },
    {
      name: "Childline",
      desc: "Free, confidential helpline for children and young people in distress or danger. Trained counselors available 24/7. Calls are free and do not show on phone bills.",
      avail: "24/7",
      avClass: "av24",
      phone: "0800 1111",
      chat: true,
    ...
    {
      name: "Mind Infoline",
      desc: "Information and signposting to local and national mental health services for anyone experiencing a mental health problem or supporting someone who is.",
  ...
  return (
    <section
      className="bg-navy dark:bg-soft w-full px-4 md:px-[5%] py-20 relative overflow-hidden"
      id="helpline"
    >
      {/* ── BACKGROUND ORB BLUR ── */}
      ...
      <div className="max-w-275 mx-auto container relative z-10">
        ...
        <div className="mb-10" data-aos="fade-up">
          ...
          <h2 className="font-fraunces text-[clamp(1.8rem,3.5vw,2.6rem)] font-light text-white dark:text-text tracking-tight leading-[1.15] mb-2.5">
            ...
            <em className="not-italic opacity-60">alone.</em>
          </h2>
          <p className="text-[0.95rem] text-white/50 dark:text-t2 font-light leading-relaxed max-w-125">
            If you're in crisis or need to talk to someone right now, these
            services are here for you. All free, all confidential. No account
            needed.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
          {HELPLINES.map((hl, index) => (
            ...
            >
              <div
                className="h-full bg-white/6 dark:bg-white border border-white/10 dark:border-bd rounded-2xl p-6 flex flex-col gap-3.5 transition-all duration-300 select-none hover:bg-white/10 dark:hover:bg-white hover:-translate-y-0.5"
              >
        ...
        {/* ── DISCLAIMER NOTE ── */}
        <div
          className="mt-8 p-[16px_20px] bg-white/5 border border-white/8 border-l-[3px] border-l-[rgba(59,130,196,0.5)] rounded-r-md"
          data-aos="fade-up"
        >
          <p className="text-[0.8rem] text-white/45 dark:text-t2 font-light leading-relaxed">
            <strong className="text-white/70 dark:text-t2 font-medium">
              Important:
            </strong>{" "}
            Mindsphere is a supportive space, not a clinical service. If you or
            someone you know is in immediate danger, please call your local
            emergency number (911, 999, 112) immediately.
          </p>
        </div>
      </div>
    </section>
